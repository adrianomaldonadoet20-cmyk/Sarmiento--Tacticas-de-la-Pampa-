...
(function () {
    ...
    const CONFIG = {
        ...
        // Cuántos enemigos hay al comenzar la partida.
        enemigosIniciales: 2,

        // En qué turnos del jugador aparece un nuevo Federal (aparición
        // temporal de amenazas, según la planificación de sprints).
        turnosDeAparicion: [4, 8],

        // Radio (en distancia Manhattan) al que un Federal detecta al
        // jugador y empieza a perseguirlo en vez de patrullar al azar.
        radioDeteccion: 3,

        // Probabilidad de golpe certero (impacto variable).
